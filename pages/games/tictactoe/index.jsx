...
const TictactoePage = ({playerAll, gameList}) => {
  ...
  return (
    <div style={{ backgroundImage: 'url("/img/dark-honeycomb.png")', height: "100vh"}}>
      <Container className="py-5 custom-button"> 
        <Row>
          <Col>
          {/* tictactoe index is 1 */}
          <GameBoard 
            gameName={gameList[1].game_name} 
            gameDescription={gameList[1].description} 
            gameCover={gameList[1].cover_url}  
            gameLink={gameList[1].game_link} />
          </Col>
        </Row>
        <Row>
